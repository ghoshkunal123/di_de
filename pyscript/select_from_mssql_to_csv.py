...
#********************************************
	...
	try:
		...
		logger.error('Failed connecting to MSSQL.')
#********************************************
...
#		for res in curr:
		...
		logger.error('Failed extracting data from mssql.')
		email_subject = 'Error! ' + py_job_name
...
#********************************************
	...
	logger.info('mssql_dsn :{}'.format(mssql_dsn))
	logger.info('mssql_user :{}'.format(mssql_user))
	logger.info('mssql_database :{}'.format(mssql_database))
