...
|DB Access||
|Python3||
|Python3 libraries sys,os,datetime,logging,pyodbc,csv,multiprocessing,json,logging,boto3,botocore,subprocess|sudo apt install python3-pip\; sudo -H pip3 install <lib>|
